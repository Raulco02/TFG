...
const FormularioAlerta = ({regla = null, onClose, theme}) => {
  ...
  useEffect(() => { //Arreglar los índices
    ...
    Object.values(regla.acciones).forEach((accion, index) => {
        ...
        setValue(`texto_accion`, accion.valor_accion || '');
    });
    }
  }, [regla]);
  ...
  const onSubmit = async (data) => {
    ...
    acciones.push({
      ...
      dispositivo_id: null,
      accion_id: 2,
      valor_accion: data.texto_accion
    })
    ...
    console.log('Alerta', regla)
    if (regla === null){
      console.log('Creando regla', objetoTransformado)
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <TextField
                        ...
                        fullWidth
                        error={!!errors[`texto_accion`]}
                        helperText={errors[`texto_accion`] && errors[`texto_accion`].message}
                      />
                    )}
                  />
                </Grid>
