...
const PlanoPopover = ({ isSmall, popoverOpen, setPopoverOpen, theme }) => {
  ...
  useEffect(() => {
    const svgElement = document.getElementById("svgPopover");
    console.log(svgElement);
    console.log(aulas);
  ...
  const widthPlano = isSmall ? "60%" : "75%";
      ...
      >
        ...
        <div style={{ width: widthPlano, height: heightPlano }}>
          {(plano === Planos.Anexo_B_1 || plano === Planos.Anexo_B_2) && (
            <Anexo_B_1 contenido={contenido} plano={plano} popover={true} theme={theme}/>
          )}
          {plano === Planos.Fermin_Caballero_B && (
            <Planta_Baja contenido={contenido} popover={true} theme={theme}/>
          )}
          {plano === Planos.Fermin_Caballero_1 && (
            <Planta_1 contenido={contenido} popover={true} theme={theme}/>
          )}
          {plano === Planos.Fermin_Caballero_2 && (
            <Planta_2 contenido={contenido} popover={true} theme={theme}/>
          )}
        </div>
